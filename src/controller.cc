...
/*  // remote mode: inverse kinematics + PD control + DOB compensation
  ...
  controller[mc::Angle_EMS] = [](robot_system &robot)
  {
    ...
    // --- EMS voltage calculation from theta_cmd (隗貞ｺｦ縺ｫ蝓ｺ縺･縺城崕蝨ｧ險育ｮ・ ---
    {
      ...
      // 蜀・・ｽE・ｽE・ｽE・ｽ・ｽE・ｽE・ｽE・ｽ邇・・ｽE・ｽE・ｽE・ｽE螳夂ｾｩ (M_PI縺御ｽｿ縺医↑縺・・ｽE・ｽE・ｽE・ｽ・ｽE・ｽE・ｽE・ｽ蠅・・ｽE・ｽE・ｽE・ｽ・ｽE・ｽE・ｽE・ｽ縺ｮ繝舌ャ繧ｯ繧｢繝・・ｽE・ｽE・ｽE・ｽE)
      #ifndef M_PI
      const double M_PI = 3.14159265358979323846;
      #endif

      // 隗貞ｺｦ縺ｮ螳夂ｾｩ・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ蠎ｦ謨ｰ豕輔°繧峨Λ繧ｸ繧｢繝ｳ縺ｸ螟画鋤・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE      const double deg2rad = M_PI / 180.0;
