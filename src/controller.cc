...
/*  // remote mode: inverse kinematics + PD control + DOB compensation
  controller[mc::remote] = [](robot_system &robot)
  {
    ...
    // invert: small finger distance (grasp) 竊・large x_d 竊・large theta_cmd (robot closes)
  ...
  controller[mc::Angle_EMS] = [](robot_system &robot)
  {
    ...
    // --- EMS voltage calculation from theta_cmd (隗貞ｺｦ縺ｫ蝓ｺ縺･縺城崕蝨ｧ險育ｮ・ ---
    {
      
      // 蜀・・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ邇・・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE螳夂ｾｩ (M_PI縺御ｽｿ縺医↑縺・・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ蠅・・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ縺ｮ繝舌ャ繧ｯ繧｢繝・・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE)
      #ifndef M_PI
      const double M_PI = 3.14159265358979323846;
      #endif

      // 隗貞ｺｦ縺ｮ螳夂ｾｩ・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽ蠎ｦ謨ｰ豕輔°繧峨Λ繧ｸ繧｢繝ｳ縺ｸ螟画鋤・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE・ｽE      const double deg2rad = M_PI / 180.0;
      double theta_min = 10.0 * deg2rad; // 10蠎ｦ
      double theta_max = 90.0 * deg2rad; // 90蠎ｦ
      
      double v_max = robot.get_from_dict("ems_voltage_threshold");
      double v_ems = robot.get_from_dict("ems_voltage_max");

      // 繧ｻ繝ｳ繧ｵ繝ｼ縺ｮ迴ｾ蝨ｨ蛟､繧貞叙蠕・(蜊倅ｽ搾ｿｽE繝ｩ繧ｸ繧｢繝ｳ縺ｨ諠ｳ螳・
      double sensor_theta = x_res(0);

      // 10蠎ｦ(min)縲・0蠎ｦ(max)縺ｮ髢薙〒 0V縲・.3V 縺ｫ繧ｹ繧ｱ繝ｼ繝ｪ繝ｳ繧ｰ
      ...
      {
        // 邱壼ｽ｢陬憺俣險育ｮ・        v_ems = (sensor_theta- theta_min) / (theta_max - theta_min) * v_max;
      }

      // 蜃ｺ蜉帙↓蜿肴丐
      f_out(1) = v_ems;

      robot.set_to_dict("theta_res_deg", sensor_theta / deg2rad); // 遒ｺ隱咲畑縺ｫ蠎ｦ謨ｰ豕輔〒繧ゆｿ晏ｭ・      robot.set_to_dict("da_ch1_voltage", v_ems);
      robot.set_to_dict("ems_voltage", v_ems);
